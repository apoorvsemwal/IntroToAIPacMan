...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        return tuple([self.startingPosition, (self.corners[0], self.corners[1], self.corners[2], self.corners[3])])
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        # if corners in state are empty that means all are covered.
        return not state[1]
...
def cornersHeuristic(state, problem):
    ...
    while unvisited_corners:
        distance, corner = min([(util.manhattanDistance(curr_node, corner), corner) for corner in unvisited_corners])
        heuristic += distance
        curr_node = corner
...
def foodHeuristic(state, problem):
    ...
    if pack_to_closest_food_dist == float('inf'):
        return 0
    return pack_to_closest_food_dist + closest_food_to_farthest_food_dist
